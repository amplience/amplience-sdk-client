...
(function ($) {
    ...
    $.widget("amp.ampCarousel", $.amp.ampStack, {
        ...
        _checkCSS3: function () {
            var prefixes = ['', 'Webkit', 'Moz', 'O', 'ms', 'Khtml'],
                cssChecks = [{'name': 'transform', 'dom': 'Transform'}, {
                    'name': 'transition',
                    'dom': 'Transition'
                }, {name: 'transitionDuration', dom: 'TransitionDuration'}, {
                    name: 'transitionTimingFunction',
                    dom: 'TransitionTimingFunction'
                }, {name: 'anim', dom: 'AnimationName'}],
                elm = this.element[0],
    ...
    (function () {
        ...
        $.amp.ampCarousel.prototype._layoutManagers['carousel3D'] = {
